...
FilterListAdvancedMb.propTypes = {
  show: PropTypes.bool
}
              ...
              <div className="filter-box__content">
                ...
                <div className="filter-box__body">
                  <div className="p-20px">
                      ...
                      <div className="form-group mb-20px">
                        ...
                        <Select
                          ...
                          value={regimes.filter(
                            item =>
                              Number(item.value) === Number(values?.ShowsX)
                          )}
                          onChange={otp => {
                        ...
                        {'GroupMemberIDs' in values && (
                          <div className="form-group mb-20px">
                            ...
                            <AsyncSelectGroupsCustomer
                              ...
                              name="GroupMemberIDs"
                              onChange={otp =>
                                setFieldValue('GroupMemberIDs', otp, false)
                              }
                              value={values.GroupMemberIDs}
                            />
                          </div>
                        )}
                      </>
                    ...
                    {values.ShowsX !== '1' && values.ShowsX !== '2' && (
                      <>
...
export default FilterListAdvancedMb
