                      ...
                      {values.ShowsX === '2' && (
                        <>
                          {'ServiceOriginalID' in values && (
                            <div className="form-group mb-20px">
                              <label>Dịch vụ gốc</label>
                              <AsyncSelectSVOriginal
                                isClearable={true}
                                menuPosition="fixed"
                                name="ServiceOriginalID"
                                onChange={otp => {
                                  setFieldValue('ServiceOriginalID', otp, false)
                                }}
                                value={values.ServiceOriginalID}
                                isMulti
                              />
                            </div>
                          )}

                          {'CardServiceID' in values && (
                            <div className="form-group mb-20px">
                              <label>Dịch vụ thẻ</label>
                              <AsyncSelectSVCardOnly
                                isMulti
                                closeMenuOnScroll={true}
                                menuPlacement="top"
                                isClearable={true}
                                ...
                                name="CardServiceID"
                                onChange={otp => {
                                  setFieldValue('CardServiceID', otp, false)
                                }}
                                value={values.CardServiceID}
                              />
                            </div>
                          )}
...
export default FilterListAdvancedSv
